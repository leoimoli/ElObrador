...
namespace waiTextSharp.utilidades
{
    ...
    class ReportePagina : PdfPageEventHelper
    {
        ...
        public ReportePagina(string encabezado, string subencabezado, string TextoAlquiler, string piePagina, ArrayList encabezadocolumnas, string logotipo, bool blnDetalle)
        {
            try
            {
                // asignar valores
            ...
            try
            {
                ...
                if (m_Activo)
                {
                    ...
                    if (m_TextoAlquiler.Length > 0)
                    {
                        ...
                        cellTmp = new PdfPCell(new Phrase(m_TextoAlquiler, fTextoAlquiler))
                        {
                            Border = (int)CeldaBorde.ninguno,
                            HorizontalAlignment = Element.ALIGN_LEFT,
