...
namespace waiTextSharp.utilidades
{
    class Comun
    {
        ...
        /// Ruta y nombre del logotipo 
        /// </summary>
        public static string AppLogotipoDos = System.Configuration.ConfigurationManager.AppSettings["AppLogotipoRepacionesDos"];
        ...
        public static string AppNombreReparaciones()
        {
            try
            {
                // nombre de la aplicación
                return "Código Reparación";
            }
            catch (Exception Ex)
            {
                // heredar
