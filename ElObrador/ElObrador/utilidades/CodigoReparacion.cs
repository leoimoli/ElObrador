...
namespace ElObrador.utilidades
{
    class CodigoReparacion
    {
        ...
        public CodigoReparacion(string Logotipo)
        {
            try
            {
                // asignar valor
        ...
        public void Generar(string ReporteNombre, Rectangle PapelTamanio, string Encabezado, string SubEncabezado, string DiasHorariosLaborales, string TextoAlquiler, string TextoLey, string PiePagina, ArrayList EncabezadoColumnas, DataTable dtbDatos)
        {
            ...
            try
            {
                ...
                m_peTmp = new ReportePaginaCodigoNroReparacion(Encabezado, SubEncabezado, DiasHorariosLaborales, TextoAlquiler, TextoLey, PiePagina, EncabezadoColumnas, m_Logotipo, true);
