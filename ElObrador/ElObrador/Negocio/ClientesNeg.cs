    ...
    public class ClientesNeg
    {
        public static bool CargarCliente(Entidades.Clientes _cliente)
        {
            ...
            try
            {
                ...
                bool UsuarioExistente = ValidarClienteExistente(_cliente.Dni);
                ...
                {
                    exito = ClientesDao.InsertCliente(_cliente);
                }
            }
            catch (Exception ex)
            {
        ...
        public static List<Entidades.Clientes> ListaDeClientes()
        {
            ...
            try
            {
                _listaClientes = ClientesDao.ListarClientes();
            }
            catch (Exception ex)
            {
            }
        ...
        public static List<Entidades.Clientes> BuscarClientePorApellidoNombre(string apellido, string nombre)
        {
            ...
            try
            {
                _lista = ClientesDao.BuscarClientePorApellidoNombre(apellido, nombre);
            }
            catch (Exception ex)
            {
            }
        ...
        public static List<Entidades.Clientes> BuscarClientePorDni(string dni)
        {
            ...
            try
            {
                _lista = ClientesDao.BuscarClientePorDni(dni);
            }
            catch (Exception ex)
            {
            }
        ...
        {
            bool existe = ClientesDao.ValidarClienteExistente(dni);
            return existe;
        }
        public static int BuscarIdProvincia(string provincia)
        {
            ...
            try
            {
                idProvincia = ClientesDao.BuscarIdProvincia(provincia);
            }
            catch (Exception ex)
            {
            }
        ...
        public static List<Clientes> BuscarInformacionLocalidad(string localidad, int idProvinciaSeleccionada)
        {
            List<Clientes> _lista = new List<Clientes>();
            try
            {
                _lista = ClientesDao.BuscarInformacionLocalidad(localidad, idProvinciaSeleccionada);
            }
            catch (Exception ex)
            {
            }
